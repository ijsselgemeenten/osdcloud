...
function Write-DarkGrayDate {
    ...
    if ($Message) {
        Write-Host -ForegroundColor DarkGray "$((Get-Date -Format 'dd-MM-yyyy HH:mm:ss')) $Message"
    }
    else {
        Write-Host -ForegroundColor DarkGray "$((Get-Date -Format 'dd-MM-yyyy HH:mm:ss')) " -NoNewline
    }
}
